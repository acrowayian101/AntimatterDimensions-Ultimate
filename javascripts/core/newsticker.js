...
["The cookie has ALWAYS been a lie.", true, "a1"], 
...
["IN THE END, IT DOESN'T ANTIMATTER -Anti-ObrenTune, Floor 10 of ToH", true, "a8"],
...
["welcome to nowhere! here you don't suffer. if you have antimatter, go become a girl, now.", true, "a14"],
["totl mid-peak remorseless -owo-chan aka CalicooKittin, a fellow Elite Obbyist", true, "a15"], 
["Can someone tell hevi to calm down? -Mee6", true, "a16"], 
["Due to Antimatter messing with physics, some 5000 teenage boys around America have been turned completely to girls. And those people at the CDC still can't figure out about Gender Bimorphism? Yeah, no. It's antimatter!!!", true, "a17"], 
["welcome to the jay toe community - your mother", true, "a18"],
["Alright -Alright", true, "a19"], 
["Hey, You! Yes. YOU! READING THIS NEWS RIGHT NOW! You are a GIRL. Maybe you think that's not true because of whatever. But remember, you are valid no matter what and being a girl isn't shameful. I promise you, you will be a confident, content and beautiful young woman in a few years time. Stay determined, new-name!", true, "a20"], 
["To be a girl or not be a girl, that is the question", true, "a21"], 
["This antimatter triggers me", true, "a22"],
["No, mom, I can't pause this game. Maybe you'll hang out with your girlfriend instead of bugging me for wasting my time on random antimatter?", true, "a23"], 
["Scientific notation has entered the battlefield.", true, "a24"], 
["Make the Universe Great Again! -Tronald Dump", true, "a25"], 
["MOM? WHAT ARE YOU DOING HERE??? THIS MY SAFE PLACE!!!", true, "a26"],
["A new religion has been created, and it just disappeared due to Acrowayians convincing that they're all girls!", true, "a27"], 
["Someone has just touched a blob, and blown up. Was the blob antimatter, or was the guy made of Explodium?", true, "a28"],
["If you are not playing on acrowayian101.github.io, you're playing a game made by an egg who doesn't know that she's actually a girl.", true, "a29"], 
["what is a gender - every jtoh player before knowing what jukereise is", true, "a30"], 
["BOO!", true, "a31"], 
["You ate for too long. -hevipelle", true, "a32"], 
["I hate myself. -Boo-chan", true, "a33"],
["owo uwu owo uwu owo", true, "a34"], 
...
["My dog ate too much antimatter, now he is doing 'meow! uwu! I'm a girl now!'", true, "a46"], 
["If you put infinity into your calculator it will result in 42!", true, "a47"],
["3 billion boys, 1.79e308 girls on earth", true, "a48"], 
["I'm in ... i don't know where... right now, i'm being trapped, help me escape this hellhole of a place called a farmer's market", true, "a49"],
["The smell of antimatter has been revealed. It smells like fresh doses of spironolactone and estradiol", true, "a50"], 
["Just another antimatter in the wall", true, "a51"], 
["GET SNIPED, WEAKLING", true, "a52"], 
["tronald dump is no longer transphobic, which is always good news", true, "a53"],
["This world situation is a SOS situation to the world!! MAYDAY, MAYDAY!!", true, "a54"], 
["the sun doesn't exist. only your mom does", true, "a55"], 
["I'm extremely NOT good at using github -your mom's son", true, "a56"],
...
["Maybe I'm trans then -Bootato-chan", true, "a60"], 
["Breaking news! Hevipelle has just announced that the buy max button is in fact going to be removed!", true, "a61"], 
["I dedicate this game to my girlfriend - Girly-Girl Antimony", true, "a62"],
...
["TIANANMEN SQUARE 6/4/1989 TIANANMEN SQUARE 6/4/1989 TIANANMEN SQUARE 6/4/1989", "new Date().getMonth() == 6 && new Date().getDate() == 4", "am123"],
